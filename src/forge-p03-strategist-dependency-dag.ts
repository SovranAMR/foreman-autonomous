...
export const FORGE_STRATEGIST_DEPENDENCY_DAG_VERSION = "1.0.0-a10";
...
// ─── Probe regression detection (P03-B04-A08) ────────────────────────────────

export interface StrategistDependencyDagProbeRegressionReport {
...
/**
 * Compare dependency DAG run records and detect probe alignment regressions.
 * A regression = probe aligned in prior run but misaligned in current run.
 */
export function detectStrategistDependencyDagProbeRegression(
  prior: StrategistDependencyDagRunRecord,
  current: StrategistDependencyDagRunRecord,
): StrategistDependencyDagProbeRegressionReport {
...
export const runStrategistDependencyDagProbeRegression = detectStrategistDependencyDagProbeRegression;

export interface StrategistDependencyDagForgeRegressionResult {
  atom: "P03-B04-A08";
  passed: boolean;
  productionSlice: StrategistDependencyDagProductionSliceResult;
  propertyFuzzSlice: StrategistDependencyDagPropertyFuzzSliceResult;
  record: StrategistDependencyDagRunRecord;
  recordValid: boolean;
  priorRecordValid: boolean;
  validationIssues: string[];
  priorValidationIssues: string[];
  probeRegression: StrategistDependencyDagProbeRegressionReport | null;
  detail: string;
}

/**
 * Execute dependency DAG probes, validate production slice + run record, property/fuzz gates,
 * and optionally detect regression vs prior run. Forge pipeline integration gate (P03-B04-A08).
 */
export function runStrategistDependencyDagForgeRegression(
  priorRecord?: StrategistDependencyDagRunRecord,
): StrategistDependencyDagForgeRegressionResult {
  const fixture = loadStrategistDependencyDagBaseline();
  const contract = getActiveStrategistDependencyDagContract();
  const productionSlice = runStrategistDependencyDagProductionSlice(fixture);
  const propertyFuzzSlice = runStrategistDependencyDagPropertyFuzzSlice(fixture);
  const record = runStrategistDependencyDagProbesWithRecord(fixture);
  ...
  if (priorRecord) {
    const priorValidation = validateStrategistDependencyDagRunRecord(priorRecord, contract);
  ...
  const probeRegression = priorRecord
    ? detectStrategistDependencyDagProbeRegression(priorRecord, record)
    : null;
...
// ─── Guard controls (P03-B04-A09) ─────────────────────────────────────────────

export interface ForgeStrategistDependencyDagGuardControls {
  atom: string;
  adversarial: {
...
export interface StrategistDependencyDagGuardCheckIssue {
  domain: "adversarial" | "performance" | "cost" | "safety";
  code: string;
  detail: string;
}

export interface StrategistDependencyDagGuardCheckResult {
  passed: boolean;
  issues: StrategistDependencyDagGuardCheckIssue[];
  metrics: {
...
export interface StrategistDependencyDagAdversarialGuardScenario {
  id: string;
  description: string;
  build: (record: StrategistDependencyDagRunRecord) => StrategistDependencyDagRunRecord;
  expectRejected: true;
}

export const FORGE_STRATEGIST_DEPENDENCY_DAG_GUARD_CONTROLS_V1: ForgeStrategistDependencyDagGuardControls =
  {
    atom: "P03-B04-A09",
    adversarial: {
      rejectTamperedRecords: true,
...
export function getForgeStrategistDependencyDagGuardControls(): ForgeStrategistDependencyDagGuardControls {
  return FORGE_STRATEGIST_DEPENDENCY_DAG_GUARD_CONTROLS_V1;
}

function parseStrategistDependencyDagIsoDurationMs(startedAt: string, completedAt: string): number {
...
export function summarizeStrategistDependencyDagTelemetry(
  telemetry: StrategistDependencyDagProbeTelemetry[],
): {
  suiteDurationMs: number;
  maxProbeDurationMs: number;
...
export function detectStrategistDependencyDagEvidenceSummaryMismatch(
  record: StrategistDependencyDagRunRecord,
): string | null {
  let alignedCount = 0;
  for (const item of record.evidence) {
...
export function detectStrategistDependencyDagFalseAlignment(
  record: StrategistDependencyDagRunRecord,
): string[] {
...
export function validateStrategistDependencyDagSafety(
  record: StrategistDependencyDagRunRecord,
  controls: ForgeStrategistDependencyDagGuardControls = getForgeStrategistDependencyDagGuardControls(),
): StrategistDependencyDagGuardCheckIssue[] {
  const issues: StrategistDependencyDagGuardCheckIssue[] = [];
  for (const item of record.evidence) {
...
export function validateStrategistDependencyDagPerformance(
  record: StrategistDependencyDagRunRecord,
  controls: ForgeStrategistDependencyDagGuardControls = getForgeStrategistDependencyDagGuardControls(),
): StrategistDependencyDagGuardCheckIssue[] {
  const issues: StrategistDependencyDagGuardCheckIssue[] = [];
  const { suiteDurationMs, maxProbeDurationMs } = summarizeStrategistDependencyDagTelemetry(
    record.telemetry,
  );
  const wallClockMs = parseStrategistDependencyDagIsoDurationMs(
...
export function validateStrategistDependencyDagCost(
  totalCostUsd: number,
  llmCalls: number,
  controls: ForgeStrategistDependencyDagGuardControls = getForgeStrategistDependencyDagGuardControls(),
): StrategistDependencyDagGuardCheckIssue[] {
...
export function buildStrategistDependencyDagAdversarialGuardScenarios(): StrategistDependencyDagAdversarialGuardScenario[] {
  return [
    {
...
export function runStrategistDependencyDagAdversarialGuardChecks(
  fixtureRecord: StrategistDependencyDagRunRecord,
  contract: StrategistDependencyDagContract = getActiveStrategistDependencyDagContract(),
  ...
  for (const scenario of scenarios) {
    ...
    const validation = validateStrategistDependencyDagRunRecord(tampered, contract);
    const falseAlignment = detectStrategistDependencyDagFalseAlignment(tampered);
    const summaryMismatch = detectStrategistDependencyDagEvidenceSummaryMismatch(tampered);
...
export function validateForgeStrategistDependencyDagGuard(
  record: StrategistDependencyDagRunRecord,
  options: {
    totalCostUsd?: number;
    llmCalls?: number;
    contract?: StrategistDependencyDagContract;
    controls?: ForgeStrategistDependencyDagGuardControls;
  } = {},
): StrategistDependencyDagGuardCheckResult {
  const controls = options.controls ?? getForgeStrategistDependencyDagGuardControls();
  const contract = options.contract ?? getActiveStrategistDependencyDagContract();
  const totalCostUsd = options.totalCostUsd ?? 0;
  const llmCalls = options.llmCalls ?? 0;
  const issues: StrategistDependencyDagGuardCheckIssue[] = [];

  issues.push(...validateStrategistDependencyDagPerformance(record, controls));
  issues.push(...validateStrategistDependencyDagCost(totalCostUsd, llmCalls, controls));
  issues.push(...validateStrategistDependencyDagSafety(record, controls));

  const falseAlignment = detectStrategistDependencyDagFalseAlignment(record);
  ...
  const summaryMismatch = detectStrategistDependencyDagEvidenceSummaryMismatch(record);
  if (summaryMismatch) {
    issues.push({
      domain: "adversarial",
  ...
  const telemetrySummary = summarizeStrategistDependencyDagTelemetry(record.telemetry);
  const wallClockMs = parseStrategistDependencyDagIsoDurationMs(
    record.provenance.startedAt,
    record.provenance.completedAt,
  );
...
// ─── Block gate and handoff (P03-B04-A10) ─────────────────────────────────────

export interface StrategistDependencyDagBlockGateEvidence {
  blockId: string;
  atom: string;
  sealedAt: string;
...
export interface StrategistDependencyDagBlockHandoffContract {
  version: string;
  atom: string;
  sourceBlock: {
    blockId: string;
  ...
  sealedArtifacts: {
    ...
    harnessVersion: string;
    probeCount: number;
    dependencyDagCategories: readonly StrategistDependencyDagCategory[];
    sourceBlockGateAtom: string;
  };
  ...
  entryCriteria: {
    ...
    dependencyDagRecordRequired: true;
  };
}

export const FORGE_P03_B04_BLOCK_GATE_V1: ForgeBlockGateDefinition = {
  version: "1.0.0",
  atom: "P03-B04-A10",
  blockId: "P03-B04",
  ...
  checks: [
    {
      ...
      atomId: "P03-B04-A01",
      description: "Dependency DAG baseline aligns with typed contract and P03-B03 block gate handoff",
    },
    {
      id: "typed_contract_coverage",
      atomId: "P03-B04-A02",
      description: "Contract declares measurable probes for all dependency DAG categories",
    },
    {
      id: "probe_matrix_aligned",
      atomId: "P03-B04-A03",
      description: "Dependency DAG probe matrix executes with zero unexpected mismatches",
    },
    {
    ...
    },
    {
      id: "regression_gate",
      atomId: "P03-B04-A08",
      description: "Regression gate passes on canonical dependency DAG matrix",
    },
    {
      id: "guard_controls",
      atomId: "P03-B04-A09",
...
export const FORGE_P03_B04_TO_B05_HANDOFF_V1: StrategistDependencyDagBlockHandoffContract = {
  version: "1.0.0",
  atom: "P03-B04-A10",
  sourceBlock: {
    blockId: "P03-B04",
    title: "Dependency DAG",
    completedAtoms: FORGE_P03_B04_BLOCK_GATE_V1.requiredAtomIds,
  },
  targetBlock: {
    blockId: "P03-B05",
    title: "Risk ve reversibility planı",
    entryAtom: "P03-B05-A01",
  },
  sealedArtifacts: {
    fixtureVersion: "1.0.0",
    contractVersion: FORGE_STRATEGIST_DEPENDENCY_DAG_CONTRACT_V1.version,
    harnessVersion: FORGE_STRATEGIST_DEPENDENCY_DAG_VERSION,
    probeCount: summarizeStrategistDependencyDagCoverage(FORGE_STRATEGIST_DEPENDENCY_DAG_CONTRACT_V1)
      .totalProbes,
    dependencyDagCategories: STRATEGIST_DEPENDENCY_DAG_CATEGORIES,
    sourceBlockGateAtom: "P03-B03-A10",
  },
  prerequisites: [
    "Dependency DAG v1 with measurable block/atom graph, boundary and recovery probes",
    "Versioned dependency DAG baseline aligned to contract probe matrix and sealed P03-B03 block gate",
    "Evidence, telemetry and provenance run records",
    "Regression and guard gates integrated with orchestrator verification",
    "Sealed P03-B03 atomization block gate referenced by sourceBlockGateAtom",
  ],
  entryCriteria: {
    description:
      "P03-B05-A01 formalizes risk and reversibility planning using sealed dependency DAG artifacts",
    requiresBlockGatePass: true,
    dependencyDagRecordRequired: true,
  },
};

export function getForgeP03B04BlockGate(): ForgeBlockGateDefinition {
  return FORGE_P03_B04_BLOCK_GATE_V1;
}

export function getForgeP03B04ToB05Handoff(): StrategistDependencyDagBlockHandoffContract {
  return FORGE_P03_B04_TO_B05_HANDOFF_V1;
}

export function validateStrategistDependencyDagBlockHandoffContract(
  handoff: StrategistDependencyDagBlockHandoffContract,
  evidence: Pick<StrategistDependencyDagBlockGateEvidence, "probeCount" | "regressionPassed" | "guardPassed">,
  contract: StrategistDependencyDagContract = getActiveStrategistDependencyDagContract(),
  ...
  if (handoff.sealedArtifacts.harnessVersion !== FORGE_STRATEGIST_DEPENDENCY_DAG_VERSION) {
    issues.push(
      `handoff harnessVersion=${handoff.sealedArtifacts.harnessVersion} active=${FORGE_STRATEGIST_DEPENDENCY_DAG_VERSION}`,
    );
  }
  if (handoff.sealedArtifacts.dependencyDagCategories.length !== STRATEGIST_DEPENDENCY_DAG_CATEGORIES.length) {
    issues.push("handoff dependencyDagCategories incomplete");
  }
  if (handoff.sealedArtifacts.sourceBlockGateAtom !== "P03-B03-A10") {
...
export function buildStrategistDependencyDagBlockGateEvidence(
  atomSeals: ForgeBlockAtomSeal[],
  regressionPassed: boolean,
  guardPassed: boolean,
  probeCount: number,
  gitCommit?: string,
  blockId = FORGE_P03_B04_BLOCK_GATE_V1.blockId,
): StrategistDependencyDagBlockGateEvidence {
  const handoff = getForgeP03B04ToB05Handoff();
  const handoffValid = validateStrategistDependencyDagBlockHandoffContract(handoff, {
    probeCount,
    regressionPassed,
    guardPassed,
  }).valid;
