...
import { detectResearcherCitationProvenanceGraphProbeRegression } from "./forge-p04-researcher-citation-provenance-graph.js";
import {
...
describe("Forge Researcher Citation Provenance Graph Regression Integration — P04-B05-A08", () => {
...
describe("Forge Researcher Risk Trade-off Regression Integration — P04-B07-A08", () => {
...
describe("Forge Researcher Phase Gate Regression Integration — P04-B10-A08", () => {
