...
- [x] **Atom 1**: Create the directory `public` if it does not exist, then write the complete self-contained file `public/index.html` replacing any existing content. Th
