...
- [/] **Atom 1**: Install the `chalk` library, which is required for console colorization. Execute `npm install chalk@^4.1.2` because this version is compatible with th
